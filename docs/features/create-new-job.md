...
![Create Job Posting - Job Details Section 1](../images/job-postings/create-job-posting1.png)
...
![Create Job Posting - Job Description Section](../images/job-postings/create-job-posting2.png)
...
![Create Job Posting - Expandable Sections](../images/job-postings/create-job-posting3.png)
...
![Create Job Posting - Interview Setup Configuration](../images/job-postings/create-job-posting4.png)
...
![Create Job Posting - Evaluation Rubric Display](../images/job-postings/create-job-posting5.png)
...
![Create Job Posting - Add Custom Question Dialog](../images/job-postings/create-job-posting6_addcustomquestion.png)
...
![Create Job Posting - Select from Categories Dialog](../images/job-postings/create-job-posting6_SelectFromCategories.png)
...
![Create Job Posting - Application & Settings Section](../images/job-postings/create-job-posting7_applicationsetting.png)
